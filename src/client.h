...
public:
    ...
    int communication_round_trip_;
    int communication_volume_;
...
public:
    ...
    void ObliviousMergeSplit(
        ...
        int level_index, // Which seed to use (usually correlates to tree level, but here used for seed selection)
        int num_levels_shuffle,   // Which bit of the hash to check
        int HOTREE_level
    );
